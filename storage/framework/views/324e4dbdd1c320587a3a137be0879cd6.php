...
<body>
    ...
    <div class="print-button">
        ...
        <a href="<?php echo e(route('paradas.show', $parada)); ?>" class="btn btn-secondary btn-lg ms-2">
    ...
    <div class="print-container">
        ...
        <div class="print-header">
            ...
            <div class="company-info">
                <strong><?php echo e(config('app.name', 'Sistema de Checklist')); ?></strong><br>
        ...
        <div class="section">
            ...
            <table class="info-table">
                ...
                <tr>
                    ...
                    <td><?php echo e($parada->data_fim ? $parada->data_fim->format('d/m/Y H:i') : 'Em andamento'); ?></td>
                </tr>
                <tr>
                    <td class="label">Tipo:</td>
                    <td><?php echo e(ucfirst($parada->tipo)); ?></td>
                    <td class="label">Duração Prevista:</td>
                    <td><?php echo e($parada->duracao_prevista_horas ?? 'Não definida'); ?> horas</td>
                </tr>
                <tr>
                    <td class="label">Status:</td>
                    <td>
                        <?php switch($parada->status):
                            case ('em_andamento'): ?> Em Andamento <?php break; ?>
                            <?php case ('concluida'): ?> Concluída <?php break; ?>
                            <?php case ('cancelada'): ?> Cancelada <?php break; ?>
                        <?php endswitch; ?>
                    </td>
        ...
        <div class="section">
            ...
            <div class="summary-metrics">
                <div class="metric-box">
                    <span class="metric-number"><?php echo e($resumo['total_equipamentos'] ?? 0); ?></span>
                    <div class="metric-label">Total Equipamentos</div>
                </div>
                <div class="metric-box">
                    <span class="metric-number"><?php echo e($resumo['testes_ok'] ?? 0); ?></span>
                    <div class="metric-label">Testes OK</div>
                </div>
                <div class="metric-box">
                    <span class="metric-number"><?php echo e($resumo['testes_problema'] ?? 0); ?></span>
                    <div class="metric-label">Problemas</div>
                </div>
                <div class="metric-box">
                    <span class="metric-number"><?php echo e($resumo['testes_pendentes'] ?? 0); ?></span>
                    <div class="metric-label">Pendentes</div>
                </div>
            </div>

            <div class="progress-section">
                <strong>Progresso Geral: <?php echo e($resumo['percentual_conclusao']); ?>%</strong>
                <div class="progress-bar-print">
                    <div class="progress-fill" style="width: <?php echo e($resumo['percentual_conclusao']); ?>%;">
        ...
        <div class="section">
            ...
            <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="area-header">
                    <?php echo e($area->nome); ?> - <?php echo e($areaPercentual ? $areaPercentual->percentual : 0); ?>% Concluído
                </div>
                
                <div class="area-progress">
                    <div class="progress-bar-print" style="height: 15px;">
                        <div class="progress-fill" style="width: <?php echo e($areaPercentual ? $areaPercentual->percentual : 0); ?>%;">
                            <?php echo e($areaPercentual ? $areaPercentual->percentual : 0); ?>%
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $area->equipamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td style="font-family: monospace;"><?php echo e($equipamento->tag); ?></td>
                                <td>
                                    <?php if($teste): ?>
                                ...
                                <td><?php echo e($teste->testado_por ?? '-'); ?></td>
                                <td>
                                ...
                                <td>
                                    <?php if($teste): ?>
                                        <?php if($teste->problema_descricao): ?>
                                            <strong>Problema:</strong> <?php echo e(Str::limit($teste->problema_descricao, 80)); ?>

                                            <?php if($teste->observacoes): ?><br><?php endif; ?>
                                        <?php endif; ?>
                                        <?php if($teste->observacoes): ?>
                                            <em>Obs:</em> <?php echo e(Str::limit($teste->observacoes, 80)); ?>
        ...
        <div class="section problems-section">
            <div class="problems-header">
                ⚠️ PROBLEMAS IDENTIFICADOS (<?php echo e($problemasIdentificados->count()); ?>)
            </div>
            ...
            <table class="equipment-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-family: monospace;"><?php echo e($problema->equipamento->tag); ?></td>
        ...
        <div class="signatures page-break">
            ...
            <div class="signature-row">
                <div class="signature-box">
                    ...
                    <div style="margin: 10px 0;"><?php echo e($parada->equipe_responsavel ?? 'Não informado'); ?></div>
        ...
        <div style="text-align: center; margin-top: 40px; font-size: 10pt; border-top: 1px solid #000; padding-top: 10px;">
            Relatório de Parada <?php echo e($parada->macro); ?> - Sistema de Checklist - <?php echo e(now()->format('d/m/Y H:i')); ?>
...
</html><?php /**PATH D:\XAMP\checklist\resources\views\paradas\print_backup.blade.php ENDPATH**/ ?>