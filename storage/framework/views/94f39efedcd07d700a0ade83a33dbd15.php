...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Sistema de Checklist de Paradas'); ?></title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: linear-gradient(135deg, var(--primary-blue), var(--secondary-blue)); box-shadow: 0 2px 10px rgba(44, 90, 160, 0.3); min-height: 76px; z-index: 1100;">
        <div class="container-fluid">
            ...
            <a class="navbar-brand fw-bold flex-grow-1 flex-md-grow-0" href="<?php echo e(route('dashboard')); ?>" style="font-size: 1rem;">
            ...
            <div class="navbar-nav ms-auto d-none d-md-flex align-items-center">
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-white fw-semibold d-flex align-items-center px-3 py-2 rounded-3" href="#" role="button" data-bs-toggle="dropdown" style="background: rgba(255,255,255,0.1); transition: all 0.3s ease; white-space: nowrap;">
                        ...
                        <span class="text-truncate" style="max-width: 200px;"><?php echo e(session('user.name', 'Usuário')); ?></span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        ...
                        <li><a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class="fas fa-sign-out-alt me-2"></i>Sair</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="navbar-nav d-md-none d-flex align-items-center ms-auto">
                <div class="nav-item dropdown">
                    <a class="nav-link text-white d-flex align-items-center px-2 py-1 rounded-2" href="#" role="button" data-bs-toggle="dropdown" style="background: rgba(255,255,255,0.1); min-width: fit-content;">
                        ...
                        <span class="text-truncate fw-medium d-none d-sm-inline" style="max-width: 120px;"><?php echo e(session('user.name', 'Usuário')); ?></span>
        ...
        <div class="row">
            ...
            <div class="sidebar p-0" id="sidebar">
                ...
                <nav class="py-2">
                    ...
                    <a href="<?php echo e(route('paradas.index')); ?>" class="<?php echo e(request()->routeIs('paradas.index') || request()->routeIs('paradas.show') || request()->routeIs('paradas.create') || request()->routeIs('paradas.edit') ? 'active' : ''); ?>">
                        <i class="fas fa-play-circle me-2"></i> Paradas Ativas
                    </a>
                    <a href="<?php echo e(route('paradas.historico')); ?>" class="<?php echo e(request()->routeIs('paradas.historico') || request()->routeIs('paradas.relatorio') ? 'active' : ''); ?>">
                        <i class="fas fa-history me-2"></i> Histórico
                    </a>
                    <a href="<?php echo e(route('areas.index')); ?>" class="<?php echo e(request()->routeIs('areas.*') ? 'active' : ''); ?>">
                        <i class="fas fa-building me-2"></i> Áreas
                    </a>
                    <a href="<?php echo e(route('equipamentos.index')); ?>" class="<?php echo e(request()->routeIs('equipamentos.*') ? 'active' : ''); ?>">
                    ...
                    <!-- Profile Management -->
                    <a href="<?php echo e(route('profile.show')); ?>" class="<?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                    ...
                    <!-- Mobile Logout Link -->
                    <a href="<?php echo e(route('logout')); ?>" class="d-md-none" style="border-top: 1px solid rgba(255,255,255,0.2); margin-top: 12px; padding-top: 12px;">
    ...
    <script src="<?php echo e(asset('js/mobile-fixes.js')); ?>"></script>
    <script>
...
<?php /**PATH C:\ProgramaçãoWeb\ProjetosWeb\checklist\resources\views/layouts/app.blade.php ENDPATH**/ ?>