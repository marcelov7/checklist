        ...
        <form id="testeForm" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <select id="teste_id" name="teste_id" required>
                    ...
                    <?php $__currentLoopData = $testes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teste): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($teste->id); ?>">Teste #<?php echo e($teste->id); ?> - <?php echo e($teste->equipamento->nome ?? 'N/A'); ?></option>
...
</html><?php /**PATH D:\XAMP\checklist\resources\views\teste-upload.blade.php ENDPATH**/ ?>