            ...
            <div class="card summary-card">
                <div class="card-body">
                    <div class="summary-header">
                        ...
                        <div>
                            <h5 class="mb-1 fw-bold"><?php echo e($parada->nome); ?></h5>
                            <div class="summary-meta">
                                <span class="summary-pill">Macro <?php echo e($parada->macro); ?></span>
                                <span class="summary-pill">Tipo <?php echo e(ucfirst($parada->tipo)); ?></span>
                                <span class="summary-pill"><?php echo e($statusLabel); ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="summary-section summary-progress">
                        ...
                        <div class="progress mt-2">
                            <div class="progress-bar bg-success" style="width: <?php echo e($percentualGeral); ?>%"></div>
                        </div>
                        <div class="progress-stats">
                            <span id="parada_percentual_geral"><?php echo e($percentualGeral); ?>%</span>
                            <span class="mx-1">•</span>
                            <span id="parada_progress_info"><?php echo e($parada->testes_ok); ?> resolvido(s) • <?php echo e($parada->testes_pendentes); ?> pendente(s)</span>
                        </div>
                    </div>

                    <div class="summary-section">
                        <div class="summary-label">Data de início</div>
                        <div class="summary-value"><?php echo e(\Carbon\Carbon::parse($parada->data_inicio)->format('d/m/Y')); ?></div>
                    </div>
                    <div class="summary-section">
                        <div class="summary-label">Duração prevista</div>
                        <div class="summary-value"><?php echo e($parada->duracao_prevista_horas ?? 'N/A'); ?> horas</div>
                    </div>
                    <div class="summary-section">
                        <div class="summary-label">Equipe responsável</div>
                        <div class="summary-value small"><?php echo e($parada->equipe_responsavel ?? 'N/A'); ?></div>
                    </div>
                    <div class="summary-section">
                        <div class="summary-label">Descrição</div>
                        <div class="summary-value small summary-description"><?php echo e($descricaoTexto); ?></div>
                    </div>
                    ...
                    <div class="summary-section summary-actions">
                        ...
                        <?php else: ?>
                            ...
                            <span class="badge <?php echo e($statusClass); ?> fs-6">
                                <i class="fas fa-circle me-1"></i><?php echo e($statusLabel); ?>
                    ...
                    <div class="summary-section summary-toolbar">
                        <a href="<?php echo e(route('paradas.index')); ?>" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-arrow-left me-1"></i>Voltar para Paradas Ativas
                        </a>
                        <a href="<?php echo e(route('paradas.relatorio', $parada)); ?>" class="btn btn-info btn-sm">
                            <i class="fas fa-chart-bar me-1"></i>Ver Relatório Completo
                        </a>
                        <a href="<?php echo e(route('paradas.show', $parada)); ?>" class="btn btn-outline-secondary btn-sm">
                            <i class="fas fa-layer-group me-1"></i>Ver Layout Atual
                        </a>
                        <?php if($parada->status === 'concluida'): ?>
                            <a href="<?php echo e(route('paradas.historico')); ?>" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card area-card area-shell shadow-sm">
                    ...
                    ?>
                    <div class="card-header <?php echo e($headerClass); ?> area-header-v3 transition-colors" data-area-id="<?php echo e($area->id); ?>">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 gap-md-0">
                            <div class="area-title">
                                ...
                                <span class="area-label"><?php echo e($area->nome); ?></span>
                            </div>
                            <div class="d-flex align-items-center gap-2 gap-md-3 w-100 w-md-auto justify-content-between justify-content-md-end">
                                ...
                                ?>
                                <span class="badge bg-light text-dark fs-7 fs-md-6 area-progress-badge" data-area-id="<?php echo e($area->id); ?>">
                                    <span class="area-completed-count"><?php echo e($areaConcluidos); ?></span>/<span class="area-total-count"><?php echo e($areaTotal); ?></span> concluídos • <span class="area-percent"><?php echo e($percentualPorArea[$area->id] ?? 0); ?>%</span>
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row">
                            ...
                            <?php $__currentLoopData = $area->equipamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php if($teste): ?>
                                <div class="col-12">
                                    <div class="equipment-card equipment-shell" id="equipamento_<?php echo e($equipamento->id); ?>_<?php echo e($teste->id); ?>">
                                        ...
                                        <div class="equipment-body">
                                            <?php $__currentLoopData = $teste->checklist_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="checklist-item checklist-line" id="item_<?php echo e($key); ?>_<?php echo e($teste->id); ?>">
                                                                ...
                                                                <?php else: ?>
                                                                    <div class="status-badge">
                                                                        ...
                                                                        <div class="action-buttons">
                                                                            <button class="btn btn-success" onclick="marcarOK('<?php echo e($key); ?>', <?php echo e($teste->id); ?>, event); return false;">
                                                                                <i class="fas fa-check me-1"></i>OK
                                                                            </button>
                                                                            <button class="btn btn-danger" onclick="reportarProblema('<?php echo e($key); ?>', <?php echo e($teste->id); ?>, event); return false;">
                                                                                <i class="fas fa-exclamation-triangle me-1"></i>Problema
                                                                            </button>
                                                                            <button class="btn btn-info" onclick="marcarNaoAplica('<?php echo e($key); ?>', <?php echo e($teste->id); ?>, event); return false;">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <div class="action-buttons">
                                                                            <?php if(empty($item['resolucao'])): ?>
                                                                                <button class="btn btn-warning" onclick="mostrarResolucao('<?php echo e($key); ?>', <?php echo e($teste->id); ?>)">
                                                                                    <i class="fas fa-wrench me-1"></i>Resolver
                                                                                </button>
                                                                            <?php else: ?>
                                                                                <button class="btn btn-success" onclick="mostrarResolucao('<?php echo e($key); ?>', <?php echo e($teste->id); ?>)">
                                                                                    <i class="fas fa-edit me-1"></i>Editar
                                                                                </button>
                                                                            <?php endif; ?>
                                                                            <button class="btn btn-outline-secondary" onclick="editarStatus('<?php echo e($key); ?>', <?php echo e($teste->id); ?>, '<?php echo e($statusAtual); ?>')" title="Alterar status">
...
const paradaFinalizada = <?php echo json_encode($paradaFinalizada, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ProgramaçãoWeb\ProjetosWeb\checklist\resources\views/paradas/show_v2.blade.php ENDPATH**/ ?>