...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Estilos específicos para cards com links */
        .ecosystem-card[href] {
            cursor: pointer;
            transition: all 0.3s ease;
        }

        .ecosystem-card[href]:hover {
            text-decoration: none !important;
            color: inherit !important;
            opacity: 0.9;
        }

        .ecosystem-card[href]:active {
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="ecosystem-section">
            <div class="ecosystem-header fade-in-up">
                ...
                <p class="ecosystem-subtitle">Acesse nossas ferramentas integradas</p>
            </div>
            ...
            <div class="ecosystem-grid">
                ...
                <a href="https://app.devaxis.com.br/login" target="_blank" class="ecosystem-card fade-in-up" style="text-decoration: none; color: inherit;">
                    <div class="card-icon">
                ...
                <a href="https://forcing.devaxis.com.br/login" target="_blank" class="ecosystem-card fade-in-up" style="text-decoration: none; color: inherit;">
                    <div class="card-icon">
                        <i class="fas fa-cogs"></i>
                    </div>
                    <div class="card-title">Controle de Forcing</div>
...
</html><?php /**PATH C:\ProgramaçãoWeb\ProjetosWeb\checklist\resources\views/auth/login.blade.php ENDPATH**/ ?>