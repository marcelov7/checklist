...
<?php $__env->startSection('title', $parada->nome); ?>
...
<div class="d-flex justify-content-between align-items-start mb-4">
    <div class="flex-grow-1 me-3">
        <div class="d-flex flex-wrap align-items-center mb-2">
            <span class="badge bg-dark me-2 mb-1 fs-6"><?php echo e($parada->macro); ?></span>
            <span class="badge bg-info me-2 mb-1"><?php echo e($parada->tipo_label); ?></span>
            <span class="badge bg-<?php echo e($parada->status == 'em_andamento' ? 'primary' : ($parada->status == 'concluida' ? 'success' : 'secondary')); ?> me-2 mb-1">
                <?php echo e(ucfirst(str_replace('_', ' ', $parada->status))); ?>

            </span>
        </div>
        <h1 class="h3 h1-md"><i class="fas fa-clipboard-check"></i> <?php echo e($parada->nome); ?></h1>
        <div class="row">
            <div class="col-md-6">
                ...
                <?php elseif($parada->duracao_real): ?>
                    <br>
                    <small class="text-warning">
                        <i class="fas fa-stopwatch"></i> Duração real: <?php echo e($parada->duracao_real); ?>h
                    </small>
                <?php endif; ?>
            </div>
            <div class="col-md-6">
                <?php if($parada->equipe_responsavel): ?>
                    <small class="text-muted">
                        ...
                        <?php echo e($parada->equipe_responsavel); ?>
...
<div class="row">
    <div class="col-12">
        <div class="alert alert-warning">
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('paradas.select-equipment', $parada)); ?>" class="btn btn-primary btn-lg">
        ...
        <div class="card progress-card text-center">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-8">
                        <h4 class="mb-0"><?php echo e($percentualGeral); ?>%</h4>
                    ...
                    <div class="col-4">
                        <svg class="progress-ring" viewBox="0 0 36 36">
                            ...
                            <path class="text-primary" stroke="currentColor" stroke-width="3" fill="none"
                                  stroke-dasharray="<?php echo e($percentualGeral); ?>, 100"
                                  d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                        </svg>
                    </div>
                </div>
                    ...
                    <?php $__currentLoopData = $percentualPorArea; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 mb-2">
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-truncate"><?php echo e($area->nome); ?></span>
                                <span class="badge bg-<?php echo e($area->percentual == 100 ? 'success' : ($area->percentual > 0 ? 'primary' : 'secondary')); ?>">
                                    <?php echo e($area->percentual); ?>%
                                </span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-<?php echo e($area->percentual == 100 ? 'success' : 'primary'); ?>" 
                                     style="width: <?php echo e($area->percentual); ?>%"></div>
                            </div>
                        </div>
    ...
    <?php $__currentLoopData = $areas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $area): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-md-6 mb-4">
            <div class="card area-card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-map-marked-alt"></i> <?php echo e($area->nome); ?></h5>
                        <?php
                            $areaProgress = $percentualPorArea->firstWhere('id', $area->id);
                            $areaPercentual = $areaProgress ? $areaProgress->percentual : 0;
                        ?>
                        <span class="badge bg-<?php echo e($areaPercentual == 100 ? 'success' : ($areaPercentual > 0 ? 'primary' : 'secondary')); ?>">
                            <?php echo e($areaPercentual); ?>%
                        </span>
                    </div>
                </div>
                <div class="card-body p-0">
                    <?php $__empty_1 = true; $__currentLoopData = $area->equipamentos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $equipamento): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                            $teste = $equipamento->testes->first();
                        ?>
                        <div class="equipamento-row p-3 border-bottom" data-equipamento-id="<?php echo e($equipamento->id); ?>">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="flex-grow-1">
                                    <h6 class="mb-1"><?php echo e($equipamento->nome); ?></h6>
                                    <small class="text-muted">
                                        <i class="fas fa-tag"></i> <?php echo e($equipamento->tag); ?>

                                    </small>
                                    <?php if($equipamento->descricao): ?>
                                        <br><small class="text-muted"><?php echo e($equipamento->descricao); ?></small>
                                    <?php endif; ?>
                                </div>
                                <div class="text-end">
                                    <span class="badge bg-<?php echo e($teste->status_color ?? 'secondary'); ?> status-badge">
                                        <?php echo e($teste->status_label ?? 'Pendente'); ?>

                                    </span>
                                    <?php if($teste): ?>
                                    <span class="badge bg-info ms-1" title="Progresso do Checklist">
                                        <i class="fas fa-clipboard-check"></i> <?php echo e($teste->checklist_progress); ?>%
                                    </span>
                                    <?php endif; ?>
                                    <br>
                                    <div class="btn-group mt-1" role="group">
                                        <button type="button" 
                                                ...
                                                onclick="abrirModalTeste(<?php echo e($teste->id ?? 0); ?>, <?php echo e($equipamento->id); ?>, '<?php echo e($equipamento->nome); ?>', '<?php echo e($equipamento->tag); ?>')"
                                                <?php echo e($parada->status != 'em_andamento' ? 'disabled' : ''); ?>>
                                            <i class="fas fa-edit"></i> Testar
                                        </button>
                                        <?php if($teste && $teste->status == 'pendente'): ?>
                                        <button type="button" 
                                                class="btn btn-sm btn-outline-success" 
                                                onclick="atualizacaoRapida(<?php echo e($teste->id); ?>, <?php echo e($equipamento->id); ?>, 'ok')"
                                                <?php echo e($parada->status != 'em_andamento' ? 'disabled' : ''); ?>

                                                title="Marcar como OK">
                                            <i class="fas fa-check"></i>
                                        </button>
                                        <?php elseif($teste && $teste->status == 'problema'): ?>
                                        <button type="button" 
                                                class="btn btn-sm btn-outline-warning" 
                                                onclick="abrirModalResolucao(<?php echo e($teste->id); ?>, <?php echo e($equipamento->id); ?>, '<?php echo e($equipamento->nome); ?>', '<?php echo e($equipamento->tag); ?>')"
                                                <?php echo e($parada->status != 'em_andamento' ? 'disabled' : ''); ?>
                            ...
                            <div class="mt-3 p-3 bg-light rounded checklist-section">
                                <div class="d-flex justify-content-between align-items-center mb-3" 
                                     ...
                                     data-bs-target="#checklist-<?php echo e($equipamento->id); ?>-<?php echo e($teste->id); ?>" 
                                     aria-expanded="false" 
                                     aria-controls="checklist-<?php echo e($equipamento->id); ?>-<?php echo e($teste->id); ?>"
                                ...
                                <div class="collapse" id="checklist-<?php echo e($equipamento->id); ?>-<?php echo e($teste->id); ?>">
                                ...
                                <div class="checklist-item-container mb-3" id="container_<?php echo e($key); ?>_<?php echo e($equipamento->id); ?>">
                                    <div class="d-flex align-items-center justify-content-between p-2 border rounded 
                                                <?php if($item['status'] == 'ok'): ?> bg-success text-white
                                                <?php elseif($item['status'] == 'nao_aplica'): ?> bg-secondary text-white text-decoration-line-through
                                                <?php elseif($item['status'] == 'nao_ok'): ?> bg-danger text-white
                                                <?php else: ?> bg-white <?php endif; ?>">
                                        <div class="flex-grow-1">
                                            <i class="<?php echo e($item['icon']); ?> me-2"></i>
                                            <span class="<?php if(in_array($item['status'], ['ok', 'nao_aplica'])): ?> text-decoration-line-through <?php endif; ?>">
                                        ...
                                        <div class="btn-group" role="group">
                                            <button type="button" 
                                                    class="btn btn-sm <?php echo e($item['status'] == 'ok' ? 'btn-light' : 'btn-outline-success'); ?> checklist-btn"
                                                    data-item="<?php echo e($key); ?>" 
                                                    data-teste-id="<?php echo e($teste->id); ?>" 
                                                    data-equipamento-id="<?php echo e($equipamento->id); ?>"
                                                    data-action="ok"
                                                    <?php echo e($parada->status != 'em_andamento' ? 'disabled' : ''); ?>>
                                                <i class="fas fa-check"></i>
                                            </button>
                                            <button type="button" 
                                                    class="btn btn-sm <?php echo e($item['status'] == 'nao_ok' ? 'btn-light' : 'btn-outline-danger'); ?> checklist-btn"
                                                    data-item="<?php echo e($key); ?>" 
                                                    data-teste-id="<?php echo e($teste->id); ?>" 
                                                    data-equipamento-id="<?php echo e($equipamento->id); ?>"
                                                    data-action="nao_ok"
                                            ...
                                            <button type="button" 
                                                    class="btn btn-sm <?php echo e($item['status'] == 'nao_aplica' ? 'btn-light' : 'btn-outline-secondary'); ?> checklist-btn"
                                                    data-item="<?php echo e($key); ?>" 
                                                    data-teste-id="<?php echo e($teste->id); ?>" 
                                                    data-equipamento-id="<?php echo e($equipamento->id); ?>"
                                    ...
                                    <div class="problema-area mt-2" 
                                         id="problema-area-<?php echo e($key); ?>-<?php echo e($teste->id); ?>"
                                         style="display: <?php echo e($item['status'] == 'nao_ok' ? 'block' : 'none'); ?>;">
                                        
                                        <?php
                                            $problemaResolvido = !empty($item['resolucao']);
                                        ?>
                                        
                                        <?php if($problemaResolvido): ?>
                                        ...
                                        <div class="p-3 bg-light border border-success rounded">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <p class="mb-1 text-muted"><?php echo e($item['problema']); ?></p>
                                            </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if(!empty($item['foto_resolucao'])): ?>
                                            <div class="mt-2">
                                                <small class="text-success">
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="abrirModalFoto('<?php echo e(Storage::url($item['foto_resolucao'])); ?>', 'Foto da Resolução - <?php echo e($key); ?>', '<?php echo e(addslashes($item['resolucao'] ?? '')); ?>')">
                                        ...
                                        <div class="p-3 bg-white border border-danger rounded">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control problema-text" 
                                                          ...
                                                          data-item="<?php echo e($key); ?>" 
                                                          data-teste-id="<?php echo e($teste->id); ?>"
                                                          id="desc_<?php echo e($key); ?>_<?php echo e($teste->id); ?>"><?php echo e($item['problema']); ?></textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" 
                                                       ...
                                                       data-item="<?php echo e($key); ?>" 
                                                       data-teste-id="<?php echo e($teste->id); ?>"
                                                       id="foto_problema_<?php echo e($key); ?>_<?php echo e($teste->id); ?>">
                                                <div class="form-text">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control resolucao-text" 
                                                          ...
                                                          data-item="<?php echo e($key); ?>" 
                                                          data-teste-id="<?php echo e($teste->id); ?>"
                                                          id="resolucao_<?php echo e($key); ?>_<?php echo e($teste->id); ?>"></textarea>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" 
                                                       ...
                                                       data-item="<?php echo e($key); ?>" 
                                                       data-teste-id="<?php echo e($teste->id); ?>"
                                                       id="foto_resolucao_<?php echo e($key); ?>_<?php echo e($teste->id); ?>">
                                                <div class="form-text">
                                                    <i class="fas fa-info-circle me-1"></i>
                                                    Máximo: 1 arquivo, 2MB. Formatos: JPG, PNG, GIF
                                                </div>
                                ...
                                <div class="mt-3">
                                    <div class="progress" style="height: 10px;">
                                        <div class="progress-bar 
                                                    <?php if($teste->checklist_progress == 100): ?> bg-success
                                                    <?php elseif($teste->checklist_progress >= 75): ?> bg-info
                                                    <?php elseif($teste->checklist_progress >= 50): ?> bg-warning
                                                    <?php else: ?> bg-danger <?php endif; ?>" 
                                             role="progressbar" 
                                             style="width: <?php echo e($teste->checklist_progress); ?>%" 
                                             id="progress_<?php echo e($equipamento->id); ?>">
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between mt-1">
                                        <small class="text-muted">Checklist: <?php echo e($teste->checklist_progress); ?>% completo</small>
                                        <small class="text-muted" id="progress_text_<?php echo e($equipamento->id); ?>">
                                            <?php if($teste->checklist_progress == 100): ?>
                                                <i class="fas fa-check-circle text-success"></i> Completo
                                            <?php else: ?>
                                                <?php echo e(6 - floor(($teste->checklist_progress / 100) * 6)); ?> itens restantes
                                            <?php endif; ?>
                                        </small>
                                    </div>
                                </div>
                                ...
                                <?php if($problemasEncontrados->count() > 0): ?>
                                <div class="mt-4 p-3 bg-light rounded historico-problemas" id="historico_problemas_<?php echo e($teste->id); ?>">
                                    <h6 class="mb-3 text-primary">
                                        <i class="fas fa-history me-2"></i>Histórico de Problemas e Resoluções
                                    </h6>
                                    
                                    <?php $__currentLoopData = $problemasEncontrados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="problema-historico mb-3 p-3 border rounded" id="historico_<?php echo e($key); ?>_<?php echo e($teste->id); ?>">
                                        ...
                                        <div class="problema-info mb-2">
                                            ...
                                            <div class="mt-2">
                                                <button type="button" 
                                                        ...
                                                        onclick="abrirModalFoto('<?php echo e(Storage::url($item['foto_problema_path'])); ?>', 'Foto do Problema - <?php echo e($key); ?>', '<?php echo e(addslashes($item['problema'] ?? '')); ?>')">
                                        ...
                                        <div class="resolucao-info mb-2">
                                            ...
                                            <div class="mt-2">
                                                <button type="button" 
                                                        ...
                                                        onclick="abrirModalFoto('<?php echo e(Storage::url($item['foto_resolucao_path'])); ?>', 'Foto da Resolução - <?php echo e($key); ?>', '<?php echo e(addslashes($item['resolucao'] ?? '')); ?>')">
                            ...
                            <?php if($teste && ($teste->observacoes || $teste->problema_descricao)): ?>
                                <div class="mt-2 p-2 bg-light rounded">
                                    <?php if($teste->observacoes): ?>
                                        <small><strong>Obs:</strong> <?php echo e($teste->observacoes); ?></small><br>
                                    <?php endif; ?>
                                    <?php if($teste->problema_descricao): ?>
                                        <small class="text-danger"><strong>Problema:</strong> <?php echo e($teste->problema_descricao); ?></small>
                                    <?php endif; ?>
                                </div>
                            <?php endif; ?>
                        </div>
...
<div class="modal fade" id="finalizarModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary btn-lg" data-bs-dismiss="modal">Cancelar</button>
                <form method="POST" action="<?php echo e(route('paradas.finalizar', $parada)); ?>" style="display: inline;">
                    <?php echo csrf_field(); ?>
...
function carregarHistoricoInicial() {
    ...
    console.log('Dados do teste (checklist):', <?php echo json_encode($teste->checklistItems, 15, 512) ?>);
    
    const itensResolvidos = [
        <?php $__currentLoopData = $teste->checklistItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item => $dados): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if(($dados['status'] === 'ok' && !empty($dados['resolucao'])) || !empty($dados['problema'])): ?>
                {
                    item: '<?php echo e($item); ?>',
                    problema: <?php echo json_encode($dados['problema'] ?? ''); ?>,
                    resolucao: <?php echo json_encode($dados['resolucao'] ?? ''); ?>,
                    foto_problema_path: <?php echo json_encode($dados['foto_problema_path'] ?? ''); ?>,
                    foto_resolucao_path: <?php echo json_encode($dados['foto_resolucao_path'] ?? ''); ?>
    ...
    itensResolvidos.forEach(function(itemData, index) {
        setTimeout(function() {
            ...
            atualizarHistoricoProblemas(<?php echo e($teste->id); ?>, itemData.item, itemData);
            
            // Atualizar contador após o último item
            if (index === itensResolvidos.length - 1) {
                setTimeout(function() {
                    atualizarContadorHistorico(<?php echo e($teste->id); ?>);
                    // Garantir que o histórico fique sempre expandido após carregamento inicial
                    const $historicoFinal = $('#historico_content_' + <?php echo e($teste->id); ?>);
                    $historicoFinal.show();
...
document.getElementById('testeForm').addEventListener('submit', function(e) {
    ...
    formData.append('parada_id', <?php echo e($parada->id); ?>);
...
function atualizarStatusChecklist(testeId, equipamentoId, item, action, $btn) {
    ...
    $.ajax({
        url: '<?php echo e(route("testes.atualizarChecklistStatus", ":id")); ?>'.replace(':id', testeId),
        method: 'PATCH',
        data: {
            item: item,
            status: action
...
function salvarProblemaCompleto(testeId, item, callback = null) {
    ...
    $.ajax({
        url: '<?php echo e(route("testes.salvarProblema", ":id")); ?>'.replace(':id', testeId),
...
function resolverProblemaCompleto(testeId, equipamentoId, item, resolucaoTexto) {
    ...
    console.log('CSRF Token:', csrfToken);
    console.log('URL da requisição:', '<?php echo e(route("testes.resolverProblema", ":id")); ?>'.replace(':id', testeId));
    ...
    $.ajax({
        url: '<?php echo e(route("testes.resolverProblema", ":id")); ?>'.replace(':id', testeId),
        method: 'POST', // Usar POST com _method=PATCH para FormData
        data: formData,
        processData: false,
        contentType: false,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMP\checklist\resources\views\paradas\show_backup.blade.php ENDPATH**/ ?>