            ...
            <div class="card">
                <div class="card-header bg-primary text-white d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-stretch align-items-md-center gap-2 gap-md-3 w-100 w-md-auto">
                        ...
                        <span id="parada_progress_info" class="badge bg-light text-dark fs-6"><?php echo e($parada->testes_ok); ?> resolvido(s) • <?php echo e($parada->testes_pendentes); ?> pendente(s)</span>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card area-card shadow-sm">
                    ...
                    ?>
                    <div class="card-header text-white <?php echo e($headerClass); ?> transition-colors" data-area-id="<?php echo e($area->id); ?>">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2 gap-md-0">
                            <h5 class="mb-0 fs-6 fs-md-5">
                                <i class="fas fa-map-marker-alt me-2"></i><span class="area-label"><?php echo e($area->nome); ?></span>
                            </h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ProgramaçãoWeb\ProjetosWeb\checklist\resources\views/paradas/show.blade.php ENDPATH**/ ?>