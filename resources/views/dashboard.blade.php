    ...
    <div class="col-6 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body text-center p-3">
                ...
                <h3 class="stat-number mb-1">{{ $totalParadas }}</h3>
    ...
    <div class="col-6 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body text-center p-3">
                ...
                <h3 class="stat-number mb-1">{{ $paradasAtivas }}</h3>
    ...
    <div class="col-6 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body text-center p-3">
                ...
                <h3 class="stat-number mb-1">{{ $paradasConcluidas ?? 0 }}</h3>
    ...
    <div class="col-6 col-lg-3">
        <div class="card stat-card h-100">
            <div class="card-body text-center p-3">
                ...
                <h3 class="stat-number mb-1">{{ $progressoGeral ?? 0 }}%</h3>
...
<div class="row">
    ...
    <div class="col-12 col-lg-8 mb-4">
        <div class="card">
            ...
            <div class="card-body">
                @if(isset($paradasRecentes) && $paradasRecentes->count() > 0)
                    <!-- Desktop Table -->
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                @foreach($paradasRecentes as $parada)
                                    <tr>
                                        <td>
                                            <div>
                                                <strong>{{ $parada->nome }}</strong>
                                                <br>
                                                <small class="text-muted">{{ $parada->macro }}</small>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="badge 
                                                @if($parada->status == 'concluida') bg-success
                                        ...
                                        <td>
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar" 
                                                     role="progressbar" 
                                                     style="width: {{ $parada->progresso_percentual ?? 0 }}%"
                                                     aria-valuenow="{{ $parada->progresso_percentual ?? 0 }}" 
                                                     aria-valuemin="0" 
                                                     aria-valuemax="100">
                                                </div>
                                            </div>
                                            <small class="text-muted">{{ $parada->progresso_percentual ?? 0 }}%</small>
                                        </td>
                                        <td>
                            ...
                            <div class="mobile-parada-card">
                                <div class="mobile-card-header">
                                    <div class="mobile-card-info">
                                        <div class="mobile-card-title">{{ $parada->nome }}</div>
                                        <div class="mobile-card-subtitle">{{ $parada->macro }}</div>
                                    </div>
                                    <div>
                                        <span class="badge 
                                            @if($parada->status == 'concluida') bg-success
                                            @elseif($parada->status == 'em_andamento') bg-warning text-dark
                                            @else bg-secondary
                                            @endif">
                                            {{ ucfirst(str_replace('_', ' ', $parada->status)) }}
                                        </span>
                                ...
                                <div class="mobile-card-details">
                                    <div class="mobile-detail-item">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small class="text-muted">{{ $parada->progresso_percentual ?? 0 }}% concluído</small>
                                        </div>
                                    </div>
                                </div>
                                
                                <div class="mobile-card-actions">
                                    <a href="{{ route('paradas.show', $parada) }}" class="btn btn-sm btn-primary flex-fill">
                    ...
                    <div class="mt-3">
                        <a href="{{ route('paradas.index') }}" class="btn btn-primary">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('equipamentos.index') }}" class="btn btn-outline-primary">
                    ...
                    @if(session('user.perfil') === 'admin')
                        <hr>
                        <a href="{{ route('usuarios.index') }}" class="btn btn-outline-info">
